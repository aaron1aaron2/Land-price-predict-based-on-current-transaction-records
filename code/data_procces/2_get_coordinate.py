...
def get_args():
    ...
    parser.add_argument('--file_path', type=str, default='data/data_procces/1_sort_data/transaction_land.csv')
    parser.add_argument('--output_folder', type=str, default='data/data_procces/2_get_coordinate')
