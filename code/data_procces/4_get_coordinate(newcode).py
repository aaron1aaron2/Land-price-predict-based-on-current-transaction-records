...
def get_args():
    ...
    parser.add_argument('--file_path', type=str, default='data/data_procces/3_land_code_transform/crawler_result.csv')
    parser.add_argument('--output_folder', type=str, default='data/data_procces/4_get_coordinate(newcode)')
